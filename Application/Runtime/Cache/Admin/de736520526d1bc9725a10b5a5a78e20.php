...
<div class="LTT_context_right">
    ...
    <table class="table table-striped">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$recruit): ?><tr>
            <td><?php echo ($recruit["rec_id"]); ?></td>
            <td><?php echo ($recruit["bus_id"]); ?></td>
            <td><?php echo ($recruit["title"]); ?></td>
            <td><?php echo ($recruit["type"]); ?></td>
            <td><?php echo ($recruit["salary_range"]); ?></td>
            <td><?php echo ($recruit["time_unit"]); ?></td>
            <td><?php echo ($recruit["cs_name"]); ?></td>
            <td><?php echo ($recruit["cs_phone"]); ?></td>
            <td><?php echo ($recruit["require"]); ?></td>
            <td><?php echo ($recruit["welfare"]); ?></td>
            <td><?php echo ($recruit["job_content"]); ?></td>
            <td><?php echo ($recruit["job_time"]); ?></td>
            <td><?php echo ($recruit["province"]); ?>-<?php echo ($recruit["city"]); ?>-<?php echo ($recruit["county"]); ?></td>
            <td><?php echo ($recruit["address"]); ?></td>
            <td><?php echo ($recruit["attention"]); ?></td>
            <td><?php echo ($recruit["apply_num"]); ?></td>
            <td><?php echo (date("Y-m-d H:i:s",$recruit["rec_time"])); ?></td>
            <td><?php echo ($recruit["status"]); ?></td>
            <td>
                <!--edit-->
...
<script>
   $(function () {
       $("#add_btn").click(function () {
           $.post("<?php echo U('Admin/Business/recruitAdd');?>",$("#add_form").serialize(),function (data) {
                if(data === "企业不存在"){
                    alert("企业不存在，请重新填写！");
       ...
       $("#edit_btn").click(function () {
            $.post("<?php echo U('Admin/business/recruitEdit');?>",$("#edit_form").serialize(),function (data) {
//                console.log(data);
                if(data === "企业不存在"){
                    alert("企业不存在，请重新填写！");
                    window.location.reload();
       ...
       $(".edit_btn").click(function () {
           ...
           $("#rec_id").val(rec_id);
           $.post("<?php echo U('Admin/Business/recruitDisplay');?>",{rec_id:rec_id},function (data) {
       ...
       $(".del_btn").on("click",function () {
           ...
           $(".delete_enter").click(function () {
               $.post("<?php echo U('Admin/business/deleteRecruit');?>",{rec_id:rec_id},function (data) {
                   if(data){
                       alert("删除成功");
                       window.location.reload();
                   }else{
