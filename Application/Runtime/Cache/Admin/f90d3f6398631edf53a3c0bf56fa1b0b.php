...
<div class="LTT_context_right">
    <div class="page-header">
        <h1>生活圈评论管理 <small>Life comment management</small></h1>
    </div>
    ...
    <table class="table table-striped">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$life): ?><tr>
            ...
            <td>
                <?php if($life["com_status"] == 1): ?><button class="btn btn-info display_btn" id="display_btn">已显示</button>
                    <?php else: ?>
...
<script>
    $(function () {
        $(".display_btn").click(function () {
            ...
            $.post("<?php echo U('Admin/Life/changeDis');?>",{com_id:$com_id},function (data) {
                if(data){
                    alert("该评论已隐藏");
        ...
        $(".hidden_btn").click(function () {
            ...
            $.post("<?php echo U('Admin/Life/changeHid');?>", {com_id:$com_id}, function (data) {
                if (data) {
                    alert("该评论已显示");
                    window.location.reload();
                }
        ...
        $(".del_btn").click(function () {
            ...
            $(".delete_enter").click(function () {
                $.post("<?php echo U('Admin/Life/deleteComment');?>",{com_id:com_id},function (data) {
                    if(data){
                        alert("删除成功");
                        window.location.reload();
                    }else{
